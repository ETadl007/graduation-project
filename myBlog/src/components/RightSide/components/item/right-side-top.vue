<template>
  ...
  <div class="info-avatar">
    <router-link to="/"><el-avatar /> </router-link>
    <span class="blog-name">简易博客</span>
  </div>
  <div class="personal-say">为什么每天不能睡25个小时啊。</div>
  <div class="common-menu flex_r_between">
    <span class="flex_c_center" @click="operate('goToArchives')">
      ...
      <span class="common-menu__value to_pointer"> 12 </span>
    </span>
    ...
    <span class="flex_c_center" @click="operate('goToTag')">
      ...
      <span class="common-menu__value to_pointer"> 80 </span>
    </span>
  </div>
