            ...
            >
              <div class="albumList-box flex_center" @click="goToPhotos(item)">
                <div class="albumList-box__mask">
                  <span class="name text_overflow"> 风景</span>
                  <span class="desc text_overflow">记录沿途风景</span>
                </div>
                <el-image class="albumList-box__image" fit="cover" lazy>
                  <template #error>
...
.center_box {
  animation: Up-63790fe8 0.6s ease-in-out forwards;
}
</style>
